...
{
    internal class JobConstructorParameterMapper : IEntityTypeConfiguration<Entities.JobConstructorParameter>
    {
        public void Configure(EntityTypeBuilder<Entities.JobConstructorParameter> builder)
        {
            // Primary Key
            ...
            builder.ToTable("Hangfire.JobDomains.JobConstructorParameter");
        }
    }
}
